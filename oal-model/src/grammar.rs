use crate::lexicon::{
    Interned, Interner, Lexicon, Symbol, TokenAlias, TokenIdx, TokenList, TokenSpan,
};
use chumsky::prelude::*;
                ...
                NodeEdge::Start(id) => {
                    ...
                    let trunk = match node.trunk() {
                        SyntaxTrunk::Leaf(t) => {
                            ...
                            let new_index = tree.push((token, span.clone()));

                            SyntaxTrunk::Leaf(TokenAlias::from(kind, new_index))
                        }
                        t => *t,
                    };
